...
/**
 * Created by Sylvain on 01.12.2015.
 */
public class ListBugDeveloperFragment extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        BugCrudActivity activity=(BugCrudActivity)getActivity();
        List<Developer> developers=activity.getDeveloperFromProject();
